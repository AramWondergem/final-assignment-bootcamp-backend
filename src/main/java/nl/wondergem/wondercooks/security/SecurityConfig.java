...
public class SecurityConfig  {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST,"/v1/cookcustomer/cook").hasAnyAuthority("COOK","ADMIN")
                .antMatchers(HttpMethod.POST, "/v1/cookcustomer/customer/**").hasAuthority("USER")
                .antMatchers(HttpMethod.POST, "/v1/menus").hasAuthority("COOK")
                .antMatchers(HttpMethod.PUT, "/v1/menus/**").hasAuthority("COOK")
                .antMatchers(HttpMethod.DELETE, "/v1/menus/**").hasAuthority("COOK")
                .antMatchers(HttpMethod.PUT, "/v1/menus/send/**").hasAuthority("COOK")
